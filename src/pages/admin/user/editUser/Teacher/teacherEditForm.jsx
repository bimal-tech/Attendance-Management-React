...
export const TeacherEditForm = (props) => {
    ...
    // console.log("formik teacher", formik.values);
    useEffect(() => {
        formik.setValues({
            ...props.initialVals,
        })
    ...
    return (<>
        ...
        <Form onSubmit={formik.handleSubmit}>
            ...
            <Form.Group className="row mb-3">
                ...
                <Col sm={9}>
                    <Form.Control type="subject_name"
                        name="subject_name"
                        size="sm"
                        onChange={formik.handleChange}
                    ...
                    {
                        formik.errors.subject_name && formik.touched.subject_name ?<span className="text-danger">{formik.errors.subject_name}</span> : ""
                    }
                </Col>
            </Form.Group>
            <Form.Group className="row mb-3">
